...
const frontend_url = "https://tubular-peony-e82490.netlify.app"
...
const placeOrder = async (req, res) => {
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `${frontend_url}/order/verify?success=true&orderId=${newOrder._id}`,
            cancel_url: `${frontend_url}/order/verify?success=false&orderId=${newOrder._id}`
        });
